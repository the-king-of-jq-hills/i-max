...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_attr__( 'Ultra-Light 100', 'i-max' ),
			'100light'  => esc_attr__( 'Ultra-Light 100', 'i-max' ),
			'100italic' => esc_attr__( 'Ultra-Light 100 Italic', 'i-max' ),
			'200'       => esc_attr__( 'Light 200', 'i-max' ),
			'200italic' => esc_attr__( 'Light 200 Italic', 'i-max' ),
			'300'       => esc_attr__( 'Book 300', 'i-max' ),
			'300italic' => esc_attr__( 'Book 300 Italic', 'i-max' ),
			'400'       => esc_attr__( 'Normal 400', 'i-max' ),
			'regular'   => esc_attr__( 'Normal 400', 'i-max' ),
			'italic'    => esc_attr__( 'Normal 400 Italic', 'i-max' ),
			'500'       => esc_attr__( 'Medium 500', 'i-max' ),
			'500italic' => esc_attr__( 'Medium 500 Italic', 'i-max' ),
			'600'       => esc_attr__( 'Semi-Bold 600', 'i-max' ),
			'600bold'   => esc_attr__( 'Semi-Bold 600', 'i-max' ),
			'600italic' => esc_attr__( 'Semi-Bold 600 Italic', 'i-max' ),
			'700'       => esc_attr__( 'Bold 700', 'i-max' ),
			'700italic' => esc_attr__( 'Bold 700 Italic', 'i-max' ),
			'800'       => esc_attr__( 'Extra-Bold 800', 'i-max' ),
			'800bold'   => esc_attr__( 'Extra-Bold 800', 'i-max' ),
			'800italic' => esc_attr__( 'Extra-Bold 800 Italic', 'i-max' ),
			'900'       => esc_attr__( 'Ultra-Bold 900', 'i-max' ),
			'900bold'   => esc_attr__( 'Ultra-Bold 900', 'i-max' ),
			'900italic' => esc_attr__( 'Ultra-Bold 900 Italic', 'i-max' ),
		);
	}
