...
function imax_setup() {
	 ...
	 */
	add_image_size( 'imax-slider-thumb', 1600, 900, true ); //(cropped)	
...
function imax_scripts_styles() {
	...
	wp_enqueue_script( 'imax-script', get_template_directory_uri() . '/js/functions.js', array( 'jquery' ), '2018-04-24', true );
	...
	wp_enqueue_style( 'imax-style', get_stylesheet_uri(), array(), '2018-04-24' );
...
function imax_import_files() {
  return array(
  	/**/
    array(
      'import_file_name'             	=> 'i-MAX Demo MAX-18',
      'import_file_url'            		=> 'https://raw.githubusercontent.com/TemplatesNext/i-max-demo/master/i-max.wordpress-max18.xml',
      'import_widget_file_url'     		=> 'https://raw.githubusercontent.com/TemplatesNext/i-max-demo/master/i-max-widgets.wie',
      'import_customizer_file_url' 		=> 'https://raw.githubusercontent.com/TemplatesNext/i-max-demo/master/i-max-export-max18.dat',
      'import_preview_image_url'     	=> 'https://raw.githubusercontent.com/TemplatesNext/i-max-demo/master/i-max-demo-max18.jpg',
    ...
    array(
      ...
      'import_notice'                	=> __( 'Please make sure you have plugin "TemplatesNext ToolKit" and "Contact Form 7" installed and active before you start the import process. <br> This process involves transfer of data and media from server to server and might take some time.', 'i-max' ),
	  'preview_url'                		=> 'http://templatesnext.org/imax/?page_id=334',
    ),
...
function imax_after_import_setup($selected_import) {
	...
	} elseif ( 'i-MAX Demo MAX-18' === $selected_import['import_file_name'] ) {
		...
		$front_page_id = get_page_by_title( 'Max 18' );
       	if ( isset( $front_page_id->ID ) ) {
			update_option( 'page_on_front', $front_page_id->ID );
        	update_option( 'show_on_front', 'page' );
       	}			
